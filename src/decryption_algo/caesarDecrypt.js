// Function to implement Caesar's cipher decryption
function caesarDecrypt(str, shift) {
  ...
  for (let i = 0; i < str.length; i++) {
    ...
    if (ascii >= 65 && ascii <= 90) {
      ascii = ((ascii - 65 - shift + 26) % 26) + 65; // Adjust for uppercase letters
    }
    // Check if the character is a lowercase letter
    else if (ascii >= 97 && ascii <= 122) {
      ascii = ((ascii - 97 - shift + 26) % 26) + 97; // Adjust for lowercase letters
    }
